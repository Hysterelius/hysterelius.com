...
Radiopharmaceutical therapy also known as RPTs, is a novel way to treat a horrific disease: cancer. 
<!-- more -->
Based on a technology that has been around for 90 years, nuclear medicine are now becoming full-on cancer treatments. Radiopharmaceuticals provide a way for cancer specialists, oncologists, to target cancer cells directly with radiation. This targeted radiation is both more accurate and less damaging to the patient. RPTs use the bodies’ natural processes to target cancer, giving greater accuracy and reliability.
...
<div class="image-set">
    <div>
        <img src="./meet-cancer/dna.gif" alt="Gif of dna breaking apart" width="200" height="200">
        <p>Broken DNA</p>
    </div>
    <div>
    ...
    <div>
        <img src="./meet-cancer/stop.gif" alt="Gif of dna breaking apart" width="200" height="200">
        <br>
...
<div class="image-set">
    <div>
        <img src="./battlers/chemo.gif" alt="Gif of dna breaking apart" width="200" height="200">
...
<div class="image-set">
    <div>
        <img src="./battlers/rt.gif" alt="Gif of dna breaking apart" width="200" height="200">
...
<div class="image-set sml">
    <div>
        <img src="./benefits/effective.gif" alt="Gif of the accuracy of RPTs using a target" width="120" height="120">
        <p>Effective</p>
    </div>
    <div>
        <img src="./benefits/cost.gif" alt="Gif of dna breaking apart" width="120" height="120">
        <br>
        <p>Cost effective</p>
    </div>
    <div>
